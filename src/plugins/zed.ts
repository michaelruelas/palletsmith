...
import type { MasterSchema, SyntaxTokenStyle, Appearance } from "../core/types.js";
...
function buildSyntaxObject(s: Record<string, SyntaxTokenStyle>): Record<string, unknown> {
