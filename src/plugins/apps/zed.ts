...
function buildZedStyle(m: MasterSchema, themeName: string) {
  ...
  return {
    ...
    "element.hover": isOneDark ? "#2c313a" : (isGitHub ? "#6e76811f" : t.hoverBackground),
    ...
    "ghost_element.hover": isOneDark ? "#2c313a" : (isGitHub ? "#6e76811f" : (isDracula ? withAlpha(t.textAccent, 0.21) : t.hoverBackground)),
    ...
    "editor.active_line.background": isOneDark ? "#2c313c" : (isGitHub ? "#6e76811a" : (isDracula ? withAlpha(t.textAccent, 0.2) : t.background)),
