...
function buildZedStyle(m: MasterSchema, themeName: string) {
  ...
  return {
    ...
    "drop_target.background": isDracula ? "#504364" : withAlpha(t.textAccent, 0.2),
    ...
    "ghost_element.disabled": isDracula ? "#ff5555ff" : t.border,
    text: t.textPrimary,
    ...
    "search.match_background": isDracula ? "#50fa7b50" : withAlpha(t.textAccent, 0.2),
