...
function buildColors(
  ...
  return {
    ...
    "editor.lineHighlightBackground": themeName === "One Dark Pro" ? "#2c313c" : t.editorBackground,
    ...
    "editorLineNumber.foreground": themeName === "Dracula" ? t.textMuted : themeName === "One Dark Pro" ? "#495162" : t.editorLineNumber,
    ...
    "statusBar.background": themeName === "Dracula" ? "#191a21" : t.statusBarBackground,
    ...
    "statusBar.noFolderBackground": themeName === "Dracula" ? "#191a21" : t.statusBarBackground,
    ...
    "input.background": themeName === "Dracula" ? "#282a36" : themeName === "One Dark Pro" ? "#1d1f23" : t.inputBackground,
    ...
    "list.activeSelectionBackground": themeName === "Dracula" ? "#44475a" : themeName === "One Dark Pro" ? "#2c313a" : t.selectionBackground,
    "list.activeSelectionForeground": themeName === "One Dark Pro" ? "#d7dae0" : t.textPrimary,
    "list.hoverBackground": themeName === "Dracula" ? withAlpha(base24.base02, 0.458) : themeName === "One Dark Pro" ? "#2c313a" : t.hoverBackground,
    ...
    "tab.activeBackground": themeName === "Dracula" ? "#282a36" : themeName === "One Dark Pro" ? "#282c34" : t.tabActiveBackground,
    "tab.inactiveBackground": themeName === "Dracula" ? "#21222c" : themeName === "One Dark Pro" ? "#21252b" : t.tabInactiveBackground,
    ...
    "tab.hoverBackground": themeName === "One Dark Pro" ? "#323842" : t.hoverBackground,
    ...
    "terminal.ansiBlack": themeName === "Dracula" ? "#21222c" : themeName === "One Dark Pro" ? "#3f4451" : term.black,
    ...
    "terminal.ansiBrightRed": themeName === "Dracula" ? "#ff6e6e" : themeName === "One Dark Pro" ? "#ff616e" : term.brightRed,
    "terminal.ansiGreen": themeName === "One Dark Pro" ? "#8cc265" : term.green,
    "terminal.ansiBrightGreen": themeName === "Dracula" ? "#69ff94" : themeName === "One Dark Pro" ? "#a5e075" : term.brightGreen,
    "terminal.ansiYellow": themeName === "One Dark Pro" ? "#d18f52" : term.yellow,
    "terminal.ansiBrightYellow": themeName === "Dracula" ? "#ffffa5" : themeName === "One Dark Pro" ? "#f0a45d" : term.brightYellow,
    "terminal.ansiBlue": themeName === "One Dark Pro" ? "#4aa5f0" : term.blue,
    "terminal.ansiBrightBlue": themeName === "Dracula" ? "#d6acff" : themeName === "One Dark Pro" ? "#4dc4ff" : term.brightBlue,
    "terminal.ansiMagenta": themeName === "One Dark Pro" ? "#c162de" : term.magenta,
    "terminal.ansiBrightMagenta": themeName === "Dracula" ? "#ff92df" : themeName === "One Dark Pro" ? "#de73ff" : term.brightMagenta,
    "terminal.ansiCyan": themeName === "One Dark Pro" ? "#42b3c2" : term.cyan,
    "terminal.ansiBrightCyan": themeName === "Dracula" ? "#a4ffff" : themeName === "One Dark Pro" ? "#4cd1e0" : term.brightCyan,
